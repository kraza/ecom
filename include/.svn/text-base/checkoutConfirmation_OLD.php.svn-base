...
<table width="550" border="1" align="center" cellpadding="10" cellspacing="0"> 
    <tr> 
        <td><strong>Step 2 Of 3 : Confirm Order</strong> </td>
    </tr>
</table>
...
?>
    <table width="550" border="1" align="center" cellpadding="5" cellspacing="1" class="infoTable">
        ...
        <tr class="label"> 
					...
					<td>Total Banner Price</td>
					<td>Pole Size</td>
					<td>Pole Qty.</td>
					<td>Pole UnitPrice</td>
					<td>Total Pole Price</td>
					<td>Total Price</td>
             </tr>
        <?php
...
?>
            <tr>
					<td>&nbsp;<?php echo $pd_id;?></td>
					<td>&nbsp;<?php echo $pd_name;?></td>
					<td>&nbsp;<?php echo $banner_size; ?></td><input type="hidden" name="hidBanner_size[]" value="<?php echo $banner_size; ?>" />
					<td>&nbsp;<?php echo $banner_qty;?></td>
					<td>&nbsp;<?php echo $banner_unitprice;?></td>
					<td>&nbsp;<?php echo $total_banner=$banner_unitprice*$banner_qty;?></td>
					<td>&nbsp;<?php echo $pole_size;?></td><input type="hidden" name="hidPole_size[]" value="<?php echo $pole_size;?>" />
					
					<td>&nbsp;<?php echo $pole_qty;?></td>
					<td>&nbsp;<?php echo $pole_unitprice;?></td>
					<td>&nbsp;<?php echo $total_pole=$pole_unitprice*$pole_qty;?></td>
				    <td>&nbsp;<?php echo $total_pro_price=$total_pole+$total_banner;?></td>
					
					  <input name="hidCartId[]" type="hidden" value="<?php echo $ct_id; ?>">
                      <input name="hidProductId[]" type="hidden" value="<?php echo $pd_id; ?>">
					  <?php $total_price +=$total_pro_price; ?>

				</tr>
        <?php
}
?>
<tr><td colspan="9" align="right">Total Amount</td><td colspan="2"><?php echo $total_price; ?></td></tr>
      <!--  <tr class="content"> 
