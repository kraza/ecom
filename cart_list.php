            ...
            <table width="755" height="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0"><?php require_once("sidebar.php"); ?>
                ...
                <td width="561"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr> 
                      <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr align="center" valign="top"><?php if(isCartEmpty()) { echo "<font size='5' color='red'>Your Shopping Cart is Empty</font>";  } else {require_once("cartitem.php");} ?> </tr></table></td>
                    </tr>
